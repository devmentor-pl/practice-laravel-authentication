...
# Laravel: Laravel: Authentication (20-23)

Prezentowane zadania są przygotowane na podstawie rozdziału "[Authentication (20-23)](https://laracasts.com/series/30-days-to-learn-laravel-11/episodes/20)" dla kursu "[30 days to learn Laravel](https://laracasts.com/series/30-days-to-learn-laravel-11)". Użyj [linku polecającego](https://laracasts.com/referral/bogolubow), aby się zarejestrować i docenić moją pracę.
